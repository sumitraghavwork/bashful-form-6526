...
temp.addEventListener('click',func1);
...
function func2(){
    ...
    if(data.length>=8){
        ...
        document.getElementById('right1').src='svg/arrow_right_alt_FILL0_wght400_GRAD0_opsz48.png'
    }
    let mylower=false;
    ...
    if(myupper&&mylower){
        ...
        document.getElementById('right2').src='svg/arrow_right_alt_FILL0_wght400_GRAD0_opsz48.png';
        document.getElementById('right2').src='svg/arrow_right_alt_FILL0_wght400_GRAD0_opsz48.png'
    }
    ...
    if(isNumber){
        ...
        document.getElementById('right3').src='svg/arrow_right_alt_FILL0_wght400_GRAD0_opsz48.png'
    }
...
function companyName(){
    ...
    if(temp==''){
        document.getElementById('cmnywarn').innerText=`Please enter the company name`;
